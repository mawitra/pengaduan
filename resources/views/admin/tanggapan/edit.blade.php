                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form" action="{{ route('admintanggapan.update',$datapengaduan->id) }}" method="Post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="country-floating" class="form-control" name="tgl_tanggapan">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" cols="30" rows="5" name="tanggapan"></textarea>
                                            </div>
                                        </div>
